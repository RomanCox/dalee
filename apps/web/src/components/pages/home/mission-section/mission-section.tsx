...
export const MissionSection = memo(({ missionData }: MissionSectionProps) => {
  ...
  useEffect(() => {
    const fetchHomeData = async () => {
      ...
      setVideoUrl(response.data.missionVideoLink);
    };
  ...
  useGSAP(
    () => {
      if (!containerRef.current || !imageRef1.current || !imageRef2.current || !imageRef3.current) return;

      const tl = gsap.to(
        [imageRef1.current, imageRef2.current, imageRef3.current],
        {
          scrollTrigger: {
  ...
  //   if (!containerRef.current || !imageRef1.current || !imageRef2.current || !imageRef3.current) return;
  //
  //   const tl = gsap.to([imageRef1.current, imageRef2.current, imageRef3.current], {
  //     yPercent: 40,
  //     scrollTrigger: {
  //       trigger: containerRef.current,
  //       scrub: true,
